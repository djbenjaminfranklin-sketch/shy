...
# Configuration - Mode tolérant pour photos mobiles avec variations d'angle
SIMILARITY_THRESHOLD = 0.70  # Seuil de distance tolérant pour ArcFace
MIN_MATCHING_PHOTOS = 1  # Au moins 1 photo sur 3 doit correspondre
MODEL_NAME = "ArcFace"  # Modèle précis pour la reconnaissance faciale
